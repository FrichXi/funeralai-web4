  ...
  return <>
    <PageContainer className="space-y-8">
      <header className="space-y-4">
        ...
        <div><h1 className="retro text-[24px] text-primary">旧榜单</h1><p className="mt-2 text-sm leading-6 text-muted-foreground">旧版 Web4 重构榜单，完整保留原来的 80 个测试站点与评分口径。</p></div>
